...
def content_detector_node(state: ComplianceState) -> ComplianceState:
    ...
    updated_state["detected_product_type"] = product_result["product_type"]
    updated_state["detected_product_label"] = product_result["label"]
    ...
    if product_result["ambiguous"] or product_result["product_type"] == "unknown":
